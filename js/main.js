...
const I18N = {
  en: {
    ...
    about_kicker: "01 — Who We Are",
    about_title: "FROM THE<br/>CANYONS.",
    about_side: "Named after the canyons of Praia Grande, Santa Catarina — the wild landscape that raised us.",
    ...
    games_kicker:"02 — Our Games", games_title:"GAMES",
    games_side:"Two titles in the making, with more on the horizon. Drop your cover art onto the slots.",
    tag_dev:"In Development", soon:"Coming Soon",
    game1_name:"Untitled Project I", game1_genre:"Co-op · Horror",
    game1_desc:"A cooperative survival experience meant to be played with friends — and feared together.",
    game2_name:"Untitled Project II", game2_genre:"Co-op · Casual",
    game2_desc:"A lighter, mobile-friendly co-op adventure — easy to pick up, hard to put down.",
    ...
    contact_kicker:"03 — Get in Touch",
  ...
  pt: {
    ...
    about_kicker: "01 — Quem Somos",
    about_title: "DOS<br/>CANYONS.",
    about_side: "Nome inspirado nos canyons de Praia Grande, Santa Catarina — a natureza que nos criou.",
    ...
    games_kicker:"02 — Nossos Jogos", games_title:"JOGOS",
    games_side:"Dois títulos em produção, com mais no horizonte. Arraste a arte das capas nos espaços.",
    tag_dev:"Em Desenvolvimento", soon:"Em Breve",
    game1_name:"Projeto Sem Título I", game1_genre:"Co-op · Terror",
    game1_desc:"Uma experiência de sobrevivência cooperativa feita para jogar com amigos — e sentir medo juntos.",
    game2_name:"Projeto Sem Título II", game2_genre:"Co-op · Casual",
    game2_desc:"Uma aventura co-op mais leve, ideal para mobile — fácil de começar, difícil de largar.",
    ...
    contact_kicker:"03 — Fale Conosco",
